...
export default function Home() {
  return (
    <div>
      <Nav></Nav>
      <section className="bg-white mt-5 " style={{ borderRadius: '15px', width: '90%', display: 'flex', flexDirection: 'column', justifySelf: 'center' }}>
        <div className="py-8 px-4 mx-auto max-w-screen-xl home text-center lg:py-16 lg:px-11 bg-gray-300" style={{ borderRadius: '15px', width: '90%' }}>

          <h1 className="mb-4 text-2xl font-extrabold tracking-tight leading-none text-gray-900 md:text-4xl lg:text-4xl dark:text-gray-900">
            Facilitons ensemble
            le commerce  <span className="text-green-900">Agricole</span>
          </h1>

          <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-700">
            Finder propose une plateforme intelligente pour faciliter l'achat et la vente de terres agricoles. En combinant transparence du marché
          </p>
          <div className="flex mt-5 flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4 ">
            <Link href="/" className="bg-green-700 dark:hover:bg-gray-700 " style={{ borderRadius: '8px' }}>
            ...
            <Link href="/">
              <span className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 text-green-700 border-gray-700 hover:bg-gray-700 focus:ring-gray-800">
        ...
        <div className="info py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div className="max-w-screen-md mb-8 lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 text-green-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4 p-4">
          <div className="h-auto bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700 m-2 sm:m-5 w-full max-w-xs sm:max-w-sm">
            ...
            <div className="p-4">
              ...
              <a href="#">
                <h5 className="mt-2 text-sm font-bold text-gray-900 dark:text-white">250 000 TND</h5>
              </a>
            </div>
          </div>
          <div className="h-auto bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700 m-2 sm:m-5 w-full max-w-xs sm:max-w-sm">
